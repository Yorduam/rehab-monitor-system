  ...
  <div>
    ...
    <Modal v-if="addModalVisible" title="Добавить пользователя" @close="addModalVisible = false">
      <form @submit.prevent="createUser">
        ...
        <div class="form-group"><label>ФИО</label><input v-model="newUser.fullName" required></div>
...
const newUser = ref({ email: '', fullName: '', password: '', role: 'recipient' });
...
const openAddModal = () => {
  newUser.value = { email: '', fullName: '', password: '', role: 'recipient' };
