...
const currentComponent = computed(() => componentMap[pageStore.current] || Dashboard);
...
// flush:'post' fires after the DOM is updated so the new page is already in place
...
<style>
/* ваши глобальные стили (оставьте без изменений) */
.loading-screen {
  display: flex;
